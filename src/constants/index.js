import { tadas, ilies, pavel, facebook, instagram, twitter, logo, slice1, roadmap, zeroToHero } from "../assets";

export const idNavLink1 = 'App';
export const idNavLink2 = 'About';
